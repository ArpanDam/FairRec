...
for k in k_range:
    ...
    def Utility_gap(dict_percentage_influenced_member):
        list1=[]
        for key in dict_percentage_influenced_member:
            list1.append(dict_percentage_influenced_member[key])
        min1=min(list1)
        max1=max(list1)
        Utility_gap=max1-min1
        return (Utility_gap)
    ...
    #print("Utility gap is  ",Utility_gap(dict_percentage_member))
...
print("Here Printing the final results")
print("Fair influential members are", seed)
print("best tags are",best_tag)
#print(Objective_f1)    
#print(dict2)    
